...
export default function StaffDashboard() {
  ...
  useEffect(() => {
    api.get('/dashboard/staff').then(res => setData(res.data)).finally(() => setLoading(false))
  }, [])
    ...
    <div className="page-enter">
      ...
      <div className={styles.quickActions}>
        ...
        <div className={styles.actionGrid}>
          <Link to="/staff/books"   className={styles.actionCard}><span className={styles.actionIcon}>📚</span><span className={styles.actionLabel}>Browse Books</span></Link>
          <Link to="/staff/issues"  className={styles.actionCard}><span className={styles.actionIcon}>📋</span><span className={styles.actionLabel}>My Books</span></Link>
          <Link to="/staff/profile" className={styles.actionCard}><span className={styles.actionIcon}>👤</span><span className={styles.actionLabel}>My Profile</span></Link>
        </div>
      </div>
      ...
      <div className={styles.recentSection}>
        <div className={styles.sectionHead}>
          ...
          <Link to="/staff/issues" className={styles.viewAll}>View all →</Link>
        </div>
        <div className={styles.recentTable}>
          {loading ? (
            ...
            <p className={styles.emptyMsg}>No books currently issued.</p>
            ...
            <div key={issue.id} className={styles.recentRow}>
              <div className={styles.recentBook}>
                ...
                <span className={styles.borrower}>{issue.book_author}</span>
              </div>
